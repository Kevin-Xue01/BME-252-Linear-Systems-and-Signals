...
% Nima Maftoom July 2021

close all

%% Delay filter example in the course note 
w=-pi:0.1:pi;
TFZ= @(z) (1)./(z.^3);
HZ1=TFZ(exp(1j*w));
figure
...
%% Notch filter example in the course note 
w=1*(-pi:0.001:pi);
TFZ= @(z) (z.^2+1)./(z.^2);
HZ1=TFZ(exp(1j*w));
figure
